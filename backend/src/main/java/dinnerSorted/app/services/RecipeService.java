...
public class RecipeService {
    ...
    private String buildUserPrompt(RecipeRequestDTO request) {
        ...
        SUNDAY SESSION RULE:
        The sundaySession must be a time-sequenced schedule that includes:
        ...
        Respond ONLY with valid JSON matching this exact structure, no markdown, no explanation:
        {
          ...
          "sundaySession": "time-sequenced prep schedule with all chopping, marinating, portioning and cooking tasks tagged and timed"
        }
        """,
                request.ingredients(),
